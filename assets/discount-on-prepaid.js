...
window.onload = function(){
 if(codAppied){
      $(".content-box__row[data-gateway-group='offsite'] input").prop("checked", false);
   $("[data-subfields-for-gateway]").addClass('hidden');
    $(".content-box__row[data-gateway-group='manual'] input").prop("checked", true);

    }
}
simply.clickEvent = function(){
  $(document).on('click', '.content-box__row[data-gateway-name="offsite_v2"] input',function(){
    console.log(">>> offsite");
//     debugger;
    if(codAppied){
